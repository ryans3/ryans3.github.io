...
/// <reference path="../objects/startscreen.ts" />
...
module states {
    ...
    export class Menu {
        ...
        public startscreen: objects.Startscreen;
        ...
        constructor() {
            ...
            //Start Screen object
            this.startscreen = new objects.Startscreen();
            this.game.addChild(this.startscreen);


            //Game Over Label
            this.mailPilotLabel = new objects.Label(320, 40, "");
